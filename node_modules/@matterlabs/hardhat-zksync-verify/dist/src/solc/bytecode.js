...
async function extractMatchingContractInformation(sourceName, contractName, buildInfo, deployedBytecode) {
    ...
    if (contract.hasOwnProperty('evm')) {
        ...
        if (analyzedBytecode !== null) {
            return Object.assign(Object.assign({}, analyzedBytecode), { compilerInput: buildInfo.input, contractOutput: buildInfo.output.contracts[sourceName][contractName], solcVersion: buildInfo.solcVersion, sourceName,
                contractName });
        }
        return null;
    }
