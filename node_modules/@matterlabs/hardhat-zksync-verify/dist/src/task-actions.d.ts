...
export declare function getContractInfo({ contractFQN, deployedBytecode, matchingCompilerVersions }: TaskArguments, { artifacts }: HardhatRuntimeEnvironment): Promise<any>;
